    ...
    <u-page-content class="pagebox">
      <view class="top">
        ...
        <view class="attribute-info-box">
          ...
          <view class="attribute-item-box">
            <text>开关状态</text>
            <text>{{dataValue.state?'开':'关'}}</text>
          </view>
        </view>
      </view>
      <view class="bottom">
       <view class="item">
          <view class=""  @click="doSwitch">
...
<script>
  export default {
    ...
    methods: {
      ...
      goLog() {
        uni.navigateTo({
          url: `/pages/equipment/socketLog?id=${this.deviceId}`
        })
      },
      goSetting() {
        uni.navigateTo({
          url: `/pages/equipment/socketSetting?id=${this.deviceId}`
        })
      },
    }
  }
