...
celery_app.autodiscover_tasks([
    'backend.apps.celery_tasks.custom_tasks',
    'backend.apps.celery_tasks.scene_ctrl',
    'backend.apps.celery_tasks.weather',
    'backend.apps.celery_tasks.sms',
    'backend.apps.celery_tasks.alarm_tasks',
